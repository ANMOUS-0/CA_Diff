...
class DynamicConv3d_Refer(nn.Module):
    def __init__(self, reference_plans,
                 in_planes, out_planes, kernel_size, ratio=0.25, stride=1, padding=0, dilation=1, groups=1, bias=True, K=4, temperature=34):
        super().__init__()
        assert in_planes%groups==0
        self.in_planes = in_planes
        self.out_planes = out_planes
        ...
        self.bias = bias
        self.K = K
        self.attention = attention3d(reference_plans, ratio, K, temperature)
